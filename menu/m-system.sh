...
res2() {
wget https://raw.githubusercontent.com/aangea/autosc/refs/heads/main/slowdns/ && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/aangea/autosc/refs/heads/main/slowdns/ && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1╭══════════════════════════════════════════╮${NC}"
